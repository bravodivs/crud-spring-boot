...
//    : catch all errors as fields and json it. check the exception class for that.
...
//    : error encountered while adding/updating due to wrong args
        return new ResponseEntity<>(errors, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(value = Exception.class)
    public ResponseEntity<Object> annotationFailure(Exception ex){
        HashMap<String, String> map = new HashMap<>();
